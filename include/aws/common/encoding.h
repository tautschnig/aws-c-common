 ...
 */
static inline void aws_write_u64(uint64_t value, uint8_t *buffer) {
 ...
 */
static inline void aws_write_u32(uint32_t value, uint8_t *buffer) {
 ...
 */
static inline void aws_write_u24(uint32_t value, uint8_t *buffer) {
    value = aws_hton32(value);
 ...
 */
static inline void aws_write_u16(uint16_t value, uint8_t *buffer) {
